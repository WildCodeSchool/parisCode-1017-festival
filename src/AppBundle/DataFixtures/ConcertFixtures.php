...
class ConcertFixtures extends Fixture implements DependentFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $concert1->setLocation($this->getReference('Elbe Philharmonic Hall'));
        ...
        $concert2->setLocation($this->getReference('Elbe Philharmonic Hall'));
        ...
        $concert3->setLocation($this->getReference('Elbe Philharmonic Hall'));
        ...
        $concert4->setLocation($this->getReference('Elbe Philharmonic Hall'));
        ...
        $concert5->setLocation($this->getReference('Elbe Philharmonic Hall'));
