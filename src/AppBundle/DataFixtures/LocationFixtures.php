...
class LocationFixtures extends Fixture
{
    public function load(ObjectManager $manager)
    {
        ...
        $location2->setName('Elbphilharmonie');
        ...
        $location5->setName('Hélène address');
        ...
        $location6->setName('Amandine address');
        ...
        $location7->setName('Agathe address');
        ...
        $this->addReference($location1->getName(), $location1);
        $this->addReference($location2->getName(), $location2);
        $this->addReference($location3->getName(), $location3);
        $this->addReference($location4->getName(), $location4);
        $this->addReference($location5->getName(), $location5);
        $this->addReference($location6->getName(), $location6);
        $this->addReference($location7->getName(), $location7);
    }
}
