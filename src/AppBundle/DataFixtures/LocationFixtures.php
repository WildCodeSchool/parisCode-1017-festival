...
class LocationFixtures extends Fixture
{
    public function load(ObjectManager $manager)
    {
        ...
        $this->addReference('Mojo Club', $location1);
        $this->addReference('Elbphilharmonie', $location2);
        $this->addReference('Reeperbahn', $location3);
        $this->addReference('Bateau', $location4);
        $this->addReference('Hélène address', $location5);
        $this->addReference('Amandine address', $location6);
        $this->addReference('Agathe address', $location7);
    }
}
